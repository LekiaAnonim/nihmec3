    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='exhibition.exhibitionformpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
